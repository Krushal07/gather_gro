...
const Cart = () => {
  ...
  const makePayment = async () => {
    ...
    const stripe = await loadStripe(
      "pk_test_51P3WBGP3QiX5wZP6swEDPqAfsRzjSBIdnsjn2nDFNe3dFgQOKZK4sVUAVPeog7Sg6krgyZUFI4HwGQs81cpQfdKY00uSGRUl1b"
    );
    ...
    <div style={{ width: "50%", margin: "0 auto" }}>
      ...
      {cartItems.length > 0 && (
        <>
              ...
              >
                ...
                >
                  ...
                  <Box sx={{ marginLeft: "auto", padding: "5px" }}>
                    <DeleteOutlined
                      onClick={() =>
                        removeItem(product.id, product.price, product.quantity)
                      }
                    />
                  </Box>
                </div>
          ...
          <CustomButton size="medium" variant="contained" onClick={makePayment}>
